---
title: Masscan [tmcybers Hidden Aim]
layout: post
post-image: /assets/images/bannergit.png
description: My masscan hidden aim cheatsheet
tags:
  - CyberSecurity
  - Hacking
  - Masscan
...
# En algunos casos, masscan es mejor que nmap

>>>> Masscan is the fastest scanner out there.[Es un scanner Ultra--Ultra Rapido]
>>>>>>Pero ten cuidado con el , porque es muy ruidoso, y si hay un equipo soc detras o siem , etcetera, te pueden pillar, pero en la practica veras que hay maneras de pasar por alto, sin que esta gente ni se enteren,<_>
...
# Como dije anteriormente en algunos casos, Masscan puede ser mejor que nmap, ten en cuenta esto.
### Por ejemplo, al buscar un rango amplio en algunos puertos solo.
### (Pentest interno, por ejemplo) puede hacer múltiples iteraciones de escaneos

## La salida XML es interesante para db_import en metasploit
```
